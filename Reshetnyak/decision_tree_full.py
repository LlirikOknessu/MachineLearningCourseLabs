...
TREES_MODELS_BEST_PARAMETERS = {
    ...
    'RandomForest': {'max_depth': 10, 'min_samples_leaf': 4, 'min_samples_split': 6, 'n_estimators': 15},
    'ExtraTree': {'max_depth': 15, 'min_samples_leaf': 3, 'min_samples_split': 10, 'n_estimators': 15}}
