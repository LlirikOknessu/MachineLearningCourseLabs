...
TREES_MODELS_BEST_PARAMETERS = {
    ...
    'RandomForest': {'max_depth': 12, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 5},
    'ExtraTree': {'max_depth': 12, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 10}}
