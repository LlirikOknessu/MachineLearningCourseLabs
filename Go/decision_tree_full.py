...
TREES_MODELS_BEST_PARAMETERS = {
    ...
    'RandomForest': {'max_depth': 4, 'min_samples_leaf': 4, 'min_samples_split': 4, 'n_estimators': 10},
    'ExtraTree': {'max_depth': 6, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 10}}
