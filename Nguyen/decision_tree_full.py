...
TREES_MODELS_BEST_PARAMETERS = {
    ...
    'RandomForest': {'max_depth': 15, 'min_samples_leaf': 1, 'min_samples_split': 7, 'n_estimators': 30},
    'ExtraTree': {'max_depth': 15, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 30}}
