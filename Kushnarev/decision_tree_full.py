...
TREES_MODELS_BEST_PARAMETERS = {
    'DecisionTree': {'max_depth': 12, 'min_samples_leaf': 4, 'min_samples_split': 4, 'splitter': 'best'},
    'RandomForest': {'max_depth': 12, 'min_samples_leaf': 3, 'min_samples_split': 7, 'n_estimators': 15},
    'ExtraTree': {'max_depth': 12, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 15}}
