...
if __name__ == '__main__':
    ...
    output_model_joblib_path = output_dir / 'XGBRegressor.joblib'
    ...
    random.seed(42)
    xgb_model = XGB()
    xgb_regressor = GridSearchCV(xgb_model, params)
    ...
    predicted_values = np.squeeze(xgb_regressor.predict(X_test))
    ...
    dump(xgb_regressor, output_model_joblib_path)