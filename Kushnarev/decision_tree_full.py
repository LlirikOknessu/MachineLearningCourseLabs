...
TREES_MODELS_BEST_PARAMETERS = {
    ...
    'RandomForest': {'max_depth': 7, 'min_samples_leaf': 3, 'min_samples_split': 15, 'n_estimators': 15},
    'ExtraTree': {'max_depth': 7, 'min_samples_leaf': 4, 'min_samples_split': 4, 'n_estimators': 15}}
